...
- **Themes** — light, dark, or follow-system, with five accent palettes (violet, emerald, rose, sky, amber). Per-device, so you can each pick your own look. The whole interface is deliberately **emoji-free** — clean type, real icons, and a folded-sheet mark.
